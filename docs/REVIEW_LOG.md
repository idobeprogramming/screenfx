...
## P36 — Delete custom presets

- Added an explicit **Delete preset** action beside the preset controls on Windows and Linux. A successful deletion updates the JSON library immediately and clears the selected name; current effects and application settings are retained.
